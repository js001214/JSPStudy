...
<TABLE border=0 width=600 cellpadding=4 cellspacing=0>
 ...
 if (request.getParameter("go") != null) { //페이지를 클릭하면 go라는 변수가 넘어간다
  where = Integer.parseInt(request.getParameter("go")); //go라는 변수에 넘어오는 값을 where에 담았다
  wheregroup = (where-1)/maxpages + 1;	//wheregroup은 현재 내가 있는 그룹이다. 1 2 3 4 5 는 1그룹 6 7 8 9 10은 2그룹
