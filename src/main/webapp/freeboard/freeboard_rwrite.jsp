...
<%
	...
	String cont = null;		// 테이블의 글 내용을 저장하는 변수 
  ...
  <FORM name='msgrewrite'  method=POST action="freeboard_rsave02.jsp">
   <table width="600" cellspacing="0" cellpadding="2" align="center">
    ...
    <tr> 
     ...
     <td width="494" style="padding:0 0 0 10" height="25"><input type=text name=email class="input_style1" value=<%=rs.getString("email") %>></td>
    </tr>
    <tr> 
...
-----------------------------------------------------------------------
    ...
    <tr> 
     ...
     <td width="494" style="padding:0 0 0 10" height="25"> 
      <input type='password' name='password'  class="input_style1" value=<%=rs.getString("password") %>><br>(정확한 비밀번호를 입력해야만 수정이 됩니다.)
     </td>
    </tr>
    <tr> 
   ...
   <INPUT type="hidden" name="step" value="<%=step%>"> <!--  name에 변수에 값이 들어가고 위로 올라간다 -->
